...
// used.
//
// When "js/vendor/pdfjs/web/viewer.js" is parsed at the end it calls
...
// by parsing "js/workersrc.js" after "js/vendor/pdfjs/web/viewer.js" and either
// calling it directly or adding it as a "DOMContentLoaded" event handler (using
// the same conditions as in "js/vendor/pdfjs/web/viewer.js").
