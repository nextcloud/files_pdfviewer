...
* This repository ([PDF viewer](https://github.com/nextcloud/files_pdfviewer/issues)) is *only* for issues within the PDF viewer code.
...
[template]: https://raw.github.com/nextcloud/files_pdfviewer/master/.github/issue_template.md
