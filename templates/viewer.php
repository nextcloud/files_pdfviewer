            ...
            <div id="toolbarViewer" class="toolbarHorizontalGroup">
              ...
              <div id="toolbarViewerRight" class="toolbarHorizontalGroup">
                ...
                <div class="toolbarHorizontalGroup hiddenMediumView">
                  ...
                  <button id="downloadButton" class="toolbarButton" type="button" disabled="disabled" title="Save" tabindex="0" data-l10n-id="pdfjs-save-button" hidden="true">
                ...
                <div id="secondaryToolbarToggle" class="toolbarButtonWithContainer">
                  ...
                  <div id="secondaryToolbar" class="hidden doorHangerRight menu">
                    <div id="secondaryToolbarButtonContainer" class="menuContainer">
                      <button id="secondaryOpenFile" class="toolbarButton labeled" type="button" title="Open File" tabindex="0" data-l10n-id="pdfjs-open-file-button" hidden="true">
                      ...
                      <div class="visibleMediumView">
                        ...
                        <button id="secondaryDownload" class="toolbarButton labeled" type="button" disabled="disabled" title="Save" tabindex="0" data-l10n-id="pdfjs-save-button" hidden="true">
                          <span data-l10n-id="pdfjs-save-button-label">Save</span>
                        </button>
