      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            <button id="secondaryOpenFile" class="toolbarButton labeled" type="button" title="Open File" tabindex="51" data-l10n-id="pdfjs-open-file-button" hidden="true">
            ...
            <button id="secondaryDownload" class="toolbarButton labeled visibleMediumView" type="button" disabled="disabled" title="Save" tabindex="53" data-l10n-id="pdfjs-save-button" hidden="true">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="download" class="toolbarButton hiddenMediumView" type="button" disabled="disabled" title="Save" tabindex="42" data-l10n-id="pdfjs-save-button" hidden="true">
                  <span data-l10n-id="pdfjs-save-button-label">Save</span>
                </button>
